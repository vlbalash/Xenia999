        ...
        return (
            <div className="w-full min-h-screen bg-stone-900 flex flex-col items-center justify-center p-6 text-center relative overflow-hidden">
                ...
                <div className="z-10 flex flex-col items-center">
                    <h1 className="text-4xl font-black font-orbitron tracking-[0.3em] text-white mb-4 drop-shadow-[0_0_15px_rgba(255,255,255,0.5)]">
                        GLACIAL GLENN
                    </h1>
                    <p className="text-stone-300 font-inter mb-12 max-w-sm text-sm leading-relaxed">
                        Premium Strategic WebGL & Development experiences engineered for scale.
                    </p>
